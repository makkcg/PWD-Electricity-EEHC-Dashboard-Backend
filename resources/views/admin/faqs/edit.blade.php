...
<section class="content clearfix">
    <form method="post" action="{{ route('admin.faqs.update',$item->id) }}" enctype="multipart/form-data">
     @csrf
        @method("put")
 <h4 class="pull-left">السؤال الشائع
  <small>تحديث السؤال الشائع</small>
</h4>

<div class="pull-right">
  <div class="col-md-12 text-right">

    <button type="submit" class="btn btn-primary margin-r-5" ><i class="fa fa-save margin-r-5"></i>تحديث السؤال الشائع</button>
...
<script type="text/javascript">
  $(document).ready(function() {
      $('.deleteImage').click(function() {
          ...
          var url = '{{ route("faq.qAndAImageAjax", ":imageID") }}';
...
<script type="text/javascript">
  $(document).ready(function() {
      $('.deleteQAndASound').click(function() {
          ...
          var url = '{{ route("faq.qAndASoundAjax", ":soundID") }}';
...
<script type="text/javascript">
  $(document).ready(function() {
      $('.deleteQAndAVideo').click(function() {
          ...
          var url = '{{ route("faq.qAndAVideoAjax", ":videoID") }}';
