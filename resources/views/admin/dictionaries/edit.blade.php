...
<section class="content clearfix">
    <form method="post" action="{{ route('admin.dictionaries.update',$item->id) }}" enctype="multipart/form-data">
     @csrf
        @method("put")
 <h4 class="pull-left">كلمة
  <small>تحديث كلمة</small>
</h4>

<div class="pull-right">
  <div class="col-md-12 text-right">

    <button type="submit" class="btn btn-primary margin-r-5" ><i class="fa fa-save margin-r-5"></i>تحديث كلمة</button>
...
<script type="text/javascript">
  $(document).ready(function() {
      $('.deleteImage').click(function() {
          ...
          var url = '{{ route("dictionary.imageAjax", ":imageID") }}';
...
<script type="text/javascript">
  $(document).ready(function() {
      $('.deleteVideo').click(function() {
        ...
        var url = '{{ route("dictionary.videoAjax", ":videoID") }}';
