...
@section('header-content')
    ...
    <section class="content-header">
        <h1>
            الاجراءات
            <small>عرض الاجراءات</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="{{ url('/admin')}}"><i class="fa fa-dashboard"></i>الرئيسية</a></li>
            <li class="active">عرض الاجراءات</li>
        </ol>
    </section>
                        ...
                        <table dir="rtl" id="example1" class="table table-bordered table-striped">
                            ...
                            @forelse($items as $key=>$item)
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{route('admin.procedures.destroy',$item)}}" method="post">

                                            <a href="{{route('admin.procedures.edit',$item)}}"
